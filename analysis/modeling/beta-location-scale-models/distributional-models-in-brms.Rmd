...
We can set priors for the intercepts as before, but now we need to also set priors for the smooth terms (instead of the linear terms). We now have coefficients for the intercept terms ($\beta_{0,~\mu}$ and $\beta_{0,~\sigma}$, specified with `class = 'Intercept'`), for the coefficients of the smooths ():
...
priors <-
  c(
    ...
    # effective degrees of freedom (a measure of wiggliness)
